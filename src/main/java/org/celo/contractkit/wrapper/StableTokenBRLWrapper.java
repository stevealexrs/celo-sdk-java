...
import org.celo.contractkit.contract.StableTokenBRL;
...
public class StableTokenBRLWrapper extends BaseWrapper<StableTokenBRL> {

    public StableTokenBRLWrapper(StableTokenBRL contract, Web3j web3j, CeloTransactionManager transactionManager, CeloGasProvider gasProvider) {
        super(contract, web3j, transactionManager, gasProvider);
    }

    public static StableTokenBRLWrapper load(String contractAddress, Web3j web3j, CeloTransactionManager transactionManager, CeloGasProvider gasProvider) {
        StableTokenBRL contract = StableTokenBRL.load(contractAddress, web3j, transactionManager, gasProvider);
        return new StableTokenBRLWrapper(contract, web3j, transactionManager, gasProvider);
    }

    public RemoteCall<StableTokenBRL> deploy() {
        return StableTokenBRL.deploy(web3j, transactionManager, gasProvider, false);
    }
