...
import org.celo.contractkit.contract.StableTokenEUR;
...
public class StableTokenEURWrapper extends BaseWrapper<StableTokenEUR> {

    public StableTokenEURWrapper(StableTokenEUR contract, Web3j web3j, CeloTransactionManager transactionManager, CeloGasProvider gasProvider) {
        super(contract, web3j, transactionManager, gasProvider);
    }

    public static StableTokenEURWrapper load(String contractAddress, Web3j web3j, CeloTransactionManager transactionManager, CeloGasProvider gasProvider) {
        StableTokenEUR contract = StableTokenEUR.load(contractAddress, web3j, transactionManager, gasProvider);
        return new StableTokenEURWrapper(contract, web3j, transactionManager, gasProvider);
    }

    public RemoteCall<StableTokenEUR> deploy() {
        return StableTokenEUR.deploy(web3j, transactionManager, gasProvider, false);
    }
